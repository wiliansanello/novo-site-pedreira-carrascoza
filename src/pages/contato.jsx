    ...
    return (
        <form className="pt-40 md:pt-28">
            ...
            <div className="md:flex flex-col md:space-x-10 my-2 text-lg px-8 md:mx-72 ">
                <p>Nome</p>
                <input type="text" placeholder="Digite seu nome..." className="px-2 my-2 text-black bg-slate-100 border-solid-black w-96 md:w-[40rem] h-10 rounded-md"/>
                <p>Cidade</p>
