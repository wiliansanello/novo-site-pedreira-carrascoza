...
export function ProductModal(props){
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className="z-20 fixed bg-slate-200 py-2 px-4 top-1/2 left-1/2 rounded-md -translate-x-1/2 -translate-y-1/2 w-[20rem] md:w-[53rem] h-[30rem] md:h-96 shadow-md shadow-slate-800" >
